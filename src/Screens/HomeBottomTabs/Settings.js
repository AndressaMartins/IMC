...
import {
    ...
    TouchableHighlight, View, Text, TextInput, Image,Button
} from 'react-native'
    ...
    render() {
        return (
            <ContainerSafeArea style={{
                    ...
                    <CardView>
                        <View style={{ marginHorizontal: 20, paddingVertical: 18, flexDirection: 'row' }}>
                            <View style={{ flexDirection: 'column', flex: 1 }}>
                                ...
                                <Text style={{ marginLeft: 20 }}>Receba sempre notificado sobre suas tarefas</Text>
                            </View>
                            <Switch
                                style={{ transform: [{ scaleX: 1.25 }, { scaleY: 1.25 }] }}
                                trackColor={{ true: '#A52A2A' }}
                ...
                >
                    <Text style={{ fontWeight: 'bold' }}>Digite sua tarefa</Text>
